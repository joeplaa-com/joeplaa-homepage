...
[![launch instance button](images/ec2-7-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/ec2-7.png)
...
[![select ubuntu 18.04 LTS - Bionic AMI](images/ec2-42-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-42.png)

3. Read the product details and optionally check pricing per instance type and click **Continue**.

[![check AMI info](images/ec2-43-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-43.png)

4. **Step 2:** Choose the instance type. We've taken a `t3.micro` for our WordPress blog. More on this choice in [Appendix D](https://blog.jodibooks.com/2020/02/hosting-asp-net-apps-aws-appendix-d-ec2-instance-type-selection/). Click **Next...** and resist the inviting blue button.

[![choose t3.micro type](images/ec2-44-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-44.png)
...
Increasing the volume size: [https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/recognize-expanded-volume-linux.html](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/recognize-expanded-volume-linux.html)

[![uncheck delete on termination and select default encryption](images/ec2-45-1024x555.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/02/10143035/ec2-45.png)
...
[![add some tags, at least a name](images/ec2-46-1024x555.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-46.png)
...
[![select Linux security group](images/ec2-47-1024x555.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-47.png)
...
[![review details](images/ec2-48-1024x555.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-48.png)
...
[![select the linux key pair](images/ec2-49-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-49.png)

After a few minutes, the instance will be in running state and we can continue with adding the IAM role.
...
[![replace IAM role](images/ec2-50-1024x554.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/02/10145321/ec2-50.png)

2. Select the IAM role we made for _WordPress_ and click **Apply**.

[![select wordpress iam role](images/ec2-51-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-51.png)
...
1\. [https://www.digitalocean.com/community/tutorials/how-to-set-up-a-firewall-with-ufw-on-ubuntu-16-04](https://www.digitalocean.com/community/tutorials/how-to-set-up-a-firewall-with-ufw-on-ubuntu-16-04)  
2\. [https://www.digitalocean.com/community/tutorials/ufw-essentials-common-firewall-rules-and-commands](https://www.digitalocean.com/community/tutorials/ufw-essentials-common-firewall-rules-and-commands)  
3\. [https://linuxize.com/post/how-to-setup-a-firewall-with-ufw-on-ubuntu-18-04/](https://linuxize.com/post/how-to-setup-a-firewall-with-ufw-on-ubuntu-18-04/)  
4\. [https://www.linode.com/docs/security/firewalls/configure-firewall-with-ufw/](https://www.linode.com/docs/security/firewalls/configure-firewall-with-ufw/)
...
[![enabled ufw rules ufw](images/ec2-55.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-55.png)
...
[![add line to /etc/fstab using nano editor](images/ec2-54.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-54.png)
...
[![memory info at start of session](images/ec2-52.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-52.png)

Memory usage info when starting an SSH session

[![top information](images/ec2-53.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-53.png)
...
[![EC2 volume information](images/ec2-56-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-56.png)

Volume vol-jodibooks-server-u01 is attached to jodibooks-server-u01 and has state "in-use".
...
[![snapshots overview](images/ec2-57-1024x553.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/02/11121341/ec2-57.png)
...
[![two ways to start creating a snapshot](images/ec2-58-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-58.png)
...
[![create a snapshot](images/ec2-59-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-59.png)

If you gave your volumes names, it's easier to select them.

3. Click **Create Snapshot** and you'll see a screen which shows the snapshot ID. Click **Close**.

[![](images/ec2-60-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-60.png)
...
[![pending and completed snapshot status](images/ec2-61-1024x616.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-61.png)
...
[![create image from snapshot](images/ec2-62-1024x554.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/02/11131827/ec2-62.png)

2. Add a _name_ and a _description_. Leave everything else as is and click **Create**.

[![add image name and description](images/ec2-63-1024x554.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/02/11132159/ec2-63.png)

3. When we now go to the AMI screen, we can see our image. The AMI doesn't need any storage as it links to the snapshot.

[![the image is created](images/ec2-64-1024x554.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/02/11132638/ec2-64.png)
...
[![launch the image](images/ec2-65-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-65.png)

* * *

## Change instance type

Should you ever want to change the instance type, you want a smaller and cheaper one, you need a bigger one or a completely [different type](https://blog.jodibooks.com/2020/02/hosting-asp-net-apps-aws-appendix-d-ec2-instance-type-selection/), you could use an image to setup the new instance.
...
If you have a database or user data on your instance (not recommended, but I'm guilty too), you have to prevent your users from entering new data while you move the data(base).

If you're OK with a few minutes of downtime, you don't have to go through the 5 steps mentioned above.

Source: [https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-resize.html](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-resize.html)

1. Select the instance in the **Instances** screen and stop it. Click **Actions**, **Instance State** and **Stop**.

[![stop the instance](images/ec2-66-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/02/ec2-66.png)

2. When the "Instance state" is _stopped_ click **Actions**, **Instance Settings** and **Change Instance Type**.

[![change instance type](images/ec2-67-1024x554.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/02/11134831/ec2-67.png)

I can't stop the instance as it is in production, but you get the idea.
...
In the [next part](https://blog.jodibooks.com/2020/01/hosting-asp-net-apps-aws-part-7-domains-and-dns-with-route-53/) we're going to setup our domain names and DNS settings. For that we will use the AWS Route 53 service.
