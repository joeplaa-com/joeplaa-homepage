...
- _[https://medium.com/@jaychapel/aws-vs-azure-vs-google-cloud-market-share-2019-what-the-latest-data-shows-dc21f137ff1c](https://medium.com/@jaychapel/aws-vs-azure-vs-google-cloud-market-share-2019-what-the-latest-data-shows-dc21f137ff1c)_
- _[https://www.digitalocean.com/press/releases/digitalocean-named-to-forbes-2019-cloud-100-list/](https://www.digitalocean.com/press/releases/digitalocean-named-to-forbes-2019-cloud-100-list/)_

## AWS basics

To understand which parts to use when building your environment in AWS and how to use them, we need to start with learning some basic concepts. I used the free [training courses](https://www.aws.training/), which I can recommend, to get a basic understanding. Check out [appendix C](https://blog.jodibooks.com/2020/02/hosting-asp-net-apps-aws-appendix-c-aws-training/) for more info on training and which ones to start with.
...
[![Architecture: AWS Regions, Availability Zones and VPC](images/AWS-architecture-Region-AZ-VPC-1024x435.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/AWS-architecture-Region-AZ-VPC.png)
...
[![Basic EC2 architecture: AWS security groups, route table and internet gateway](images/AWS-architecture-Subnet-SG.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/AWS-architecture-Subnet-SG.png)
...
[![Naming of EC2 instances with tags for applications, databases and tools](images/AWS-naming.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/01/06171450/AWS-naming.png)
...
![Our ugly long Public DNS name ec2-18-195-19-249.eu-central-1.compute.amazonaws.com](images/AWS-public-DNS.png)
...
This was a long read with much information and yet we still haven't built anything. Let's start with actually configuring something in the [next part](https://blog.jodibooks.com/2020/01/hosting-asp-net-apps-aws-part-4-iam-users-and-roles/).
