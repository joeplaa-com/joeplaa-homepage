...
[![register a new domain name](images/route53-01-1024x556.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/route53-01.png)
...
[![add available domain to cart](images/route53-02-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/route53-02.png)
...
[![enter contact details](images/route53-03-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/route53-03.png)
...
[![verify the details](images/route53-04-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/route53-04.png)

I'm going to cancel as I don't want jodibooks.net.
...
[![transfer domain](images/route53-05-1024x616.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/route53-05.png)

2. Type the domain name you want to transfer and click the **Check** button. If the domain is transferable, you can **continue**.

[![check if domain is available](images/route53-06-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/route53-06.png)
...
[![confirm transfer of domain](images/route53-07.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/route53-07.png)
...
[![create a hosted zone](images/route53-08-1024x555.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/route53-08.png)

2. Enter the domain name for which you want to create the hosted zone and click the **Create** button.

[![enter your domain name](images/route53-09-1024x555.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/route53-09.png)
...
[![create the top level record](images/route53-10-1024x555.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/01/11172700/route53-10.png)
...
[![add cname for www](images/route53-11-1024x555.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/01/11173152/route53-11.png)
...
[![list of subdomains in hosted zone](images/route53-12-1024x555.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/route53-12.png)
...
[![create a health check](images/route53-13-1024x555.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/route53-13.png)
...
[![add domain to check](images/route53-14-1024x611.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/route53-14.png)
...
[![create an alarm](images/route53-15-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/route53-15.png)
...
During the creation of the health check alarm we touched the SNS service. [SNS](https://aws.amazon.com/sns/) stands for Simple Notification Service and can only send simple, plain text messages. We'll return to SNS in more detail in [part 14](https://blog.jodibooks.com/2020/01/hosting-asp-net-apps-aws-part-14-monitoring-with-cloudwatch/).

To our customers however we want to send styled emails and we want to receive email in a user-friendly manner. This is configured in the [next part](https://blog.jodibooks.com/2020/01/hosting-asp-net-apps-aws-part-8-email-with-workmail-and-ses/).
