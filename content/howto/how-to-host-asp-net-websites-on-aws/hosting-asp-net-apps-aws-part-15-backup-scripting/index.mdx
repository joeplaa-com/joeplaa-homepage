...
[![iam policies overview](images/mon-26-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-26.png)
...
[![add json policy](images/mon-27-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-27.png)

3. Once the policy is created attach it to roles `EC2-jodibooks-dotnetapp` and `EC2-jodibooks-WordPress`.

* * *

## Create the MSSQL backup script

### 1\. Create dump database script

1. Open SSMS on your local computer and connect to the database. **Right-click** and click on **Tasks** and **Back Up...**

[![connect to the database and backup](images/scripts-01-1024x616.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/01/20173504/scripts-01.png)

2. Set _Backup type_ to `Full`, select **Copy-only backup**, _Back up to_ `Disk` and add the location to store the backup (see [part 11](https://blog.jodibooks.com/2020/01/hosting-asp-net-apps-aws-part-11-database-in-ms-sql/#export-database) for more details).

[![copy-only backup settings](images/scripts-02-1024x616.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/01/20173944/scripts-02.png)

3. Click **Script** and **Script Action to File**. Save the file to `<database>_backup.sql` and close SSMS.

![click script action to file](images/scripts-03-1024x616.png)

### 2\. Add 7-zip to encrypt and compress

1. Download 7-zip: [https://www.7-zip.org/download.html](https://www.7-zip.org/download.html).
...
## Create the Windows log backup script
...
## Create the Linux log backup script
...
[![task scheduler library](images/scripts-04-1024x616.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/scripts-04.png)
...
[![general tab create task](images/scripts-05.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/01/20190129/scripts-05.png)
...
[![set dialy trigger](images/scripts-06.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/scripts-06.png)

7. Click the **Actions** tab and click **New**. Browse to the script and add your encryption password as argument.

[![start script with encryption password](images/scripts-07.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/scripts-07.png)
...
[![settings of task](images/scripts-08.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/scripts-08.png)
...
Should you want to have a different schedule, try this site to generate it: [https://crontab-generator.org/](https://crontab-generator.org/)
