...
[![main cloudwatch dashboard](images/mon-01-1024x552.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-01.png)
...
### 1\. Creating the IAM user and role

1. Go to the IAM console and click **Roles**. Now open the EC2 roles we made for our instances (one at a time).

[![open ec2 roles in iam](images/mon-02-1024x553.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/01/20110916/mon-02.png)
...
[![policy added to role](images/mon-03-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-03.png)
...
[![add cloudwatch parameter store user](images/mon-09-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-09.png)

5. Add permissions `CloudWatchAgentAdminPolicy` and `AmazonSSMManagedInstanceCore`: click **Attach existing policies** and search.

[![add permissions](images/mon-10-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-10.png)

6. Optionally add tags and create the user. Copy and store the credentials!

### 2\. Install agent

You can install the agent in multiple ways. You can do it manually and through the Systems Manager (SSM). Installing through the Systems Manager has some other advantages. Because you have to add your instances, you can now check and apply updates through the manager.

1. Open the AWS System Manager console by searching for `SSM` service. Click **Run Command** in the menu.

[![run command in systems manager](images/mon-04-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-04.png)

2. In the first pane _Command document_ select `AWS-ConfigureAWSPackage`.

[![select the configureawspackage command](images/mon-05-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-05.png)

3. Scroll down and in the _Actions_ pane choose `Install` as _Action_ and enter `AmazonCloudWatchAgent` as name.

[![set command parameters](images/mon-07-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-07.png)

4. Scroll down further and in the _Targets_ pane select the instances you want to install the CloudWatch agent on.

[![select the instances as targets](images/mon-06-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-06.png)
...
[![set log output to s3](images/mon-08-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-08.png)

6. Scroll all the way down and click **Run**.

More info in this guide by AWS: [To download the CloudWatch agent using Systems Manager](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/download-CloudWatch-Agent-on-EC2-Instance-SSM-first.html).
...
`D:\apps\www\logs\PublicWebsite\*log`

`jodiBooksLogsBeauty`

`{instance_id}-jodibooksWWW`

`D:\logs\*.log`

`ScriptLogsBeauty`

`{instance_id}-scriptsLOG`

`D:\logs\*.txt`

`ScriptLogsBeauty`

`{instance_id}-scriptsTXT`
...
[![log groups overview](images/mon-11-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-11.png)

2. Click the **Metric filters** tab and click **Create metric filter**.

[![instances per stream](images/mon-12-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-12.png)
...
[![add filter pattern](images/mon-13-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-13.png)
...
[![enter metric details](images/mon-14-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-14.png)

5. Check all values and create the metric

[![review and create metric](images/mon-15-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-15.png)

6. Back in the _Metric filters_ tab, select the newly created `HttpError404` metric and click the **Create alarm** button.

[![Create alarm for metric](images/mon-17-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-17.png)
...
[![set alarm conditions](images/mon-16-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-16.png)
...
[![4 week history for 404](images/mon-18-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-18.png)
...
[![create an sns topic](images/mon-19-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-19.png)
...
[![Per instance metrics](images/mon-20-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-20.png)
...
[![Simple metric alarm](images/mon-21-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-21.png)
...
[![Cloudwatch alarm topic details. One subscription to our email.](images/mon-22-1024x554.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/01/20163827/mon-22.png)
...
[![enable stored bytes column](images/mon-23-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-23.png)

2. Open a group and click **Actions**. In the menu popping out click **Edit retention settings**.

[![group actions menu](images/mon-24-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/mon-24.png)

3. Now select the time you want to store the log data.

[![set retention time](images/mon-25-1024x553.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/01/20170617/mon-25.png)

## Next: backup scripts

In the [next part](https://blog.jodibooks.com/2020/01/hosting-asp-net-apps-aws-part-15-backup-scripting/) we're going to build some scripts to backup our databases and log files to S3.
