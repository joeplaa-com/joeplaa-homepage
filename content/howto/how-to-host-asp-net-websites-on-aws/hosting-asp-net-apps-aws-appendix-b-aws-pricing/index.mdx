...
[![Simple pricing calculator?](images/appB-01.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/appB-01.png)
...
[Simple Monthly Calculator](https://calculator.s3.amazonaws.com/index.html#r=FRA&s=EC2&key=files/calc-49511952b7f4aeea9161b234d5f4eabe88849546&v=ver20200219tB)

$ 23.18

$ 189

[Pricing Calculator](https://calculator.aws/#/estimate?id=7ca4c8f8e24df3f979eeb2d9d266e42640694a1a)
...
We don't use RDS for our database yet and for "good" reason. It's quite expensive for a small database. However, we do want to start using it when we are able to migrate our MSSQL database to MySQL. More on that in [appendix E](https://blog.jodibooks.com/2020/02/hosting-asp-net-apps-on-aws-appendix-e-improved-architectures/).
...
[MSSQL](https://calculator.s3.amazonaws.com/index.html#r=FRA&s=RDS&key=files/calc-31595d720a1c435e8f11bee28f0cd4572f2251ef&v=ver20200219tB)
...
[MySQL](https://calculator.aws/#/estimate?id=2f153c975cdc5184894f5ad166cafabf17bbdcaa)
...
[Aurora](https://calculator.aws/#/estimate?id=2f153c975cdc5184894f5ad166cafabf17bbdcaa)
