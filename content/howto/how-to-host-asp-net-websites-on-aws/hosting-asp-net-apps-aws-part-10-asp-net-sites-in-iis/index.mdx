...
[![server manager dashboard](images/iis-01-1024x616.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-01.png)

2. Select **Role-based or feature-based installation** and click next.

![select role-base](images/iis-02.png)

3. Choose **Select a server from the server pool**, select the `jodibooks-W01` server and click **Next**.

[![select a server](images/iis-03.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-03.png)
...
[![select iis features](images/iis-04.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-04.png)

I already had most features installed when making this screenshot.
...
[![select .net framework 4.7 features](images/iis-05.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-05.png)

6. Press **Install** to start adding the selected features.

[![start installing features](images/iis-06.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-06.png)
...
1. Download the installer from: [https://www.microsoft.com/web/downloads/platform.aspx](https://www.microsoft.com/web/downloads/platform.aspx)
...
[![webPI in IIS](images/iis-07-1024x616.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-07.png)
...
## Deploy our ASP.NET applications
...
Obviously `apps` are our published ASP.NET applications. `databases` is used as a temp folder for database exports and backups. `download` to upload new files to, like a new application release or installer. Exports from the Task Scheduler ([Part 15](https://blog.jodibooks.com/2020/01/hosting-asp-net-apps-aws-part-15-backup-scripting/)) are put in `jobs` and `scripts` contains the scripts (also [Part 15](https://blog.jodibooks.com/2020/01/hosting-asp-net-apps-aws-part-15-backup-scripting/)) to backup the database and log files. The script logs are stored in `logs`.
...
[![grant permissions to IIS_IUSR](images/iis-08.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-08.png)

4. Open the _IIS Manager_. Delete the default website under **Sites**. Click **Application Pools** and **Add Application Pool...**

[![add application pool](images/iis-09-1024x616.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-09.png)

5. Give the application pool a name: `jodibooks-main` or `jodibooks-apps` or just `jodibooks`.

[![give the pool a name](images/iis-10.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-10.png)
...
[![memory use per app pool in different configurations](images/iis-13-1024x507.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-13.png)
...
[![go to authentication](images/iis-11-1024x616.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-11.png)
...
[![application pool identity should be selected](images/iis-12-1024x616.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-12.png)
...
[![Add website in iis](images/iis-14-1024x616.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-14.png)
...
[![add application to website](images/iis-15-1024x616.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-15.png)
...
[![Add an application to a website](images/iis-16-1024x616.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-16.png)
...
[![custom port security group](images/iis-17-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-17.png)
...
[![create application user](images/iis-18-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-18.png)

2. Select **Attach existing policies directly** and click **Create policy**.

[![add policy to user](images/iis-19-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-19.png)
...
[![specify policy actions](images/iis-20-1024x553.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-20.png)
...
[![limit access to specific bucket](images/iis-21-1024x554.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/01/17151714/iis-21.png)
...
[![all objects in bucket allowed](images/iis-22-1024x553.png)](https://s3-eu-central-1.amazonaws.com/jodibooks-public-cdn/blog/wp-content/uploads/2020/01/17152055/iis-22.png)
...
[![add policy name and description](images/iis-23-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-23.png)
...
[![search for the newly created policy](images/iis-24-1024x554.png)](https://blog.jodibooks.com/wp-content/uploads/2020/01/iis-24.png)
...
That's it for the applications. With the configuration of Route 53 in [part 7](https://blog.jodibooks.com/2020/01/hosting-asp-net-apps-aws-part-7-domains-and-dns-with-route-53/), they should be reachable over an unencrypted HTTP connection. Before we add the SSL certificate, we need to [configure our database first](https://blog.jodibooks.com/2020/01/hosting-asp-net-apps-aws-part-11-database-in-ms-sql/).
