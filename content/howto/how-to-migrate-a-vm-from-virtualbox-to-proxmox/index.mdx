...
<Alert type='warning'>
If you don't get visual VNC output, you might need to change the graphics adapter or increase the graphics memory amount. I had to set the latter to 64 MB.
