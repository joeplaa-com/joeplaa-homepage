...
<Alert type='info'>
The "official" tutorial, with all the [images](https://imgur.com/a/lSg9Lzt) and a [Youtube video](https://youtu.be/I-e1_CTa4s0) on how to install and configure Proxmox can be found here:
...
You have to set a timeout of 20 seconds in grub. I can't remember how I did that, but at least here are the sources I could recover.
