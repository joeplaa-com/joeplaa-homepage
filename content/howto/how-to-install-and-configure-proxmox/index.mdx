...
:::caution
If you install Proxmox using BIOS or UEFI mode the OS should be booted in the same mode as well. So **do not change boot option in the BIOS after installation!**
:::
...
1. Open a SSH shellsession to the Proxmox node.
2. Browse to folder:
