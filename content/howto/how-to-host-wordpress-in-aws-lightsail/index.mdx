...
8. When starting a new SSH session, Ubuntu will display the amount of used memory, but you can also see it by using top or htop. These can be opened by simply typing `top` or `htop` in the terminal.
    ...
    ![memory info at start of session](../how-to-host-asp-net-websites-on-aws/hosting-asp-net-apps-aws-part-6-servers-in-ec2-part-2/ec2-52.png)

    Memory usage info when starting an SSH session

    ![top information](../how-to-host-asp-net-websites-on-aws/hosting-asp-net-apps-aws-part-6-servers-in-ec2-part-2/ec2-53.png)
