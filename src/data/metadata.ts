...
export const metadata = {
    ...
    pageBlogDescription: 'My blog with subjects from diet to politics, but lately mostly about lighter stuff like homelabbing and running stuff in the AWS cloud.',
    pageBlogTitle: 'Blog',
    ...
    pageHomeSubtitle: 'Homelabbing, hosting & personal stuff',
    pageHomeTitle: 'Home',
    ...
    pageWikiTitle: 'Wiki',
    siteDescription: 'Homelabbing, hosting & personal stuff',
...
export const urls = {
    ...
    external: {
        blog: 'https://blog.joeplaa.com',
        jodibooks: 'https://jodibooks.com/',
        recommended: 'https://blog.joeplaa.com/recommended',
