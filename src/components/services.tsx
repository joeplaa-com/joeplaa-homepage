...
const ServicesComponent = ({ className }: SectionProps): ReactElement => {
    return (
        <section className={className} id={metadata.componentServicesTitle}>
            <Container className='mb-3 mt-3'>
                <Card className='mb-3'>
                    <CardBody className='d-flex flex-column justify-content-between'>
                        ...
                        <p>{content.PricelistExample} <NewTabLink href={urls.external.jodibooks}>jodibooks.com</NewTabLink>.</p>
                    </CardBody>
                </Card>
                ...
                <Card className='mb-3'>
                    <CardBody className='d-flex flex-column justify-content-between'>
                        ...
                        <p>Head over to <NewTabLink href={urls.external.jodibooks}>jodibooks.com</NewTabLink> to find more info about our software and to try the free demo (currently Dutch only).</p>
                    </CardBody>
                </Card>
            </Container>
        </section>
